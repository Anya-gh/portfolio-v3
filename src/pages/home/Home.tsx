    ...
    <>
      <div className='flex flex-col items-center h-screen w-screen justify-between px-10 py-5'>
        ...
        <div className='flex flex-col md:flex-row items-center mt-10'>
          <img src={logo} className='mb-2 md:mb-0 md:mr-5 h-40'/>
          <span className='flex flex-col font-bold md:mb-8'><h1 className='tracking-widest text-4xl'>Aniket Singh</h1><h2 className='text-royalgold text-2xl'>Software Engineer</h2></span>
        </div>
